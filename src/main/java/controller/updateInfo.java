    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("update")!=null){
            ...
            case "ESTUDIANTE": 
                ...
                boolean sale_solo = Boolean.parseBoolean(request.getParameter("sale_solo"));
                ...
                url = "/tallerDeInglesUAEM/view/principal_students.jsp";
                break;
            case "ADMINISTRADOR" :
                ...
                url = "/tallerDeInglesUAEM/view/principal_admin.jsp"; 
                break;
            case "PROFESOR":
                String status = request.getParameter("status");
                int grupo = Integer.parseInt(request.getParameter("grupo"));
                Teachers teacher = new Teachers(idprincipal,iduser,apaterno,amaterno,nombre,
                        phone1, email, (Object) birthdate,status, grupo);
                base.actualizarTeacher(teacher);
                url = "/tallerDeInglesUAEM/view/principal_teacher.jsp"; 
                break;
            }
